...
3. ReentrantLock等待可中断，持有锁的线程长期不释放的时候，正在等待的线程可以选择放弃等待，这相当于Synchronized来说可以避免出现死锁的情况。
...
![](https://github.com/ni-jeff/Notebooks/blob/main/Interview/Java_Backend/thread_stat.jpeg)
